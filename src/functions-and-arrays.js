...
for (i = 0; i<numbersAvg.length; i++){
  sumElement += numbersAvg[i];
}
let avgElement = sumElement/numbersAvg.length;
return avgElement
}
...
for (i = 0; i< wordsArr.length; i++){
  avgLetter += wordsArr[i].length;
}
let avgString = avgLetter/wordsArr.length;
return avgString
}
